...
export class AdjustDatabase1785955175617 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refreshes" DROP CONSTRAINT "UQ_668e0e7ce31b3050d2fb814102b"`);
        await queryRunner.query(`ALTER TABLE "refreshes" DROP COLUMN "token_hash"`);
        await queryRunner.query(`ALTER TABLE "refreshes" ADD "token_hash" character varying(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "refreshes" ADD CONSTRAINT "UQ_668e0e7ce31b3050d2fb814102b" UNIQUE ("token_hash")`);
