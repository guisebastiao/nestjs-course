...
export class AlterTablesRefreshesAndRecoverPasswordsDatesInToTimestampz1785458025777 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "recover_passwords" DROP CONSTRAINT "FK_b7d0034e48284d32f01191367b9"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "recover_passwords" ADD "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "recover_passwords" DROP COLUMN "used_at"`);
    await queryRunner.query(
      `ALTER TABLE "recover_passwords" ADD "used_at" TIMESTAMP WITH TIME ZONE`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "recover_passwords" ADD CONSTRAINT "FK_b7d0034e48284d32f01191367b9" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD CONSTRAINT "FK_176b502c5ebd6e72cafbd9d6f70" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "refreshes" ADD CONSTRAINT "FK_10cf954c641bb826b68120dbc5d" FOREIGN KEY ("replaced_by_id") REFERENCES "refreshes"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "refreshes" ADD CONSTRAINT "FK_7ff4045990bb1360108a6779b31" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "recover_passwords" ADD CONSTRAINT "FK_b7d0034e48284d32f01191367b9" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
